              ...
              <AnimatePresence>
                ...
                >
                  <div className='relative group'>
                    ...
                    <motion.div className='overlay absolute inset-0 bg-black bg-opacity-50 flex justify-center items-center rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300'>
